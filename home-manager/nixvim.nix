{ pkgs, config, ... }: {
  ...
  programs.nixvim = with config.lib.stylix.colors; {
    ...
    plugins = {
      ...
      #  enable = true;
      #  autoStart = true;
      #  transparentGroups = [ "Normal" "Float" ];  # Set specific groups to be transparent
      #  transparencyLevel = 0.5;  # Adjust the transparency level (0.0 to 1.0)
      #}; 
    };
    ...
    # Enable spellcheck for some filetypes
     {
      ...
      command = "setlocal spell spelllang=en,in";
     }
     {
      event = "FileType";
      pattern = "nix";
